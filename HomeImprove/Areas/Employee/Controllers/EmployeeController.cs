...
namespace HomeImprove.Areas.Employee.Controllers
{
	[Area("Employee")]
	public class EmployeeController : Controller
	{
        ...
        public IActionResult Index()
		{
			...
			List<Handyman> objHandymanEmployeeList = _unitOfWork.Handyman.GetAllByUsername(u => u.Email == userName, includeProperties: "Category").ToList();
			return View(objHandymanEmployeeList);
		}
		...
		public IActionResult GetAllByUsername()
		{
			string userName = User.Identity.GetUserName();
			List<Handyman> objHandymanEmployeeList = _unitOfWork.Handyman.GetAllByUsername(u => u.Email == userName, includeProperties: "Category").ToList();
			return Json(new { data = objHandymanEmployeeList });
		}
